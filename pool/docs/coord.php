...
//--- подпись для ТЕРМИНАЛОВ
	if($_GET['m']=='terminals'){
		//--- карта
		if (file_exists('pool/src/coord_data/terminals2.inc')){
			include('pool/src/coord_data/terminals2.inc');
//			$v1=@file('pool/src/coord_data/terminals2.inc');
	//		print implode("\r\n",$v1);
		//	print '<br />';
		}
		...
		print '<ul class="list2">';
			...
			print '<li>совершить платежи (для индивидуальных предпринимателей) в Пенсионный фонд, в Фонд социального страхования и Налоговую инспекцию. Плата за оформление составит 20 рублей;</li>';
			print '<li>заплатить за обучение в Рязанском Государственном Радиотехническом Университете. Комиссия 50 рублей;</li>';
			print '<li>заплатить за проживание в общежитии, за тестирование и подготовительные курсы в РГРТУ. Комиссия составит 30 рублей;</li>';
			print '<li>заплатить за посещение курсов ИЗО студии и городской школы программистов в РГРТУ. Комиссия составит 30 рублей;</li>';
		print '</ul>';
	...
	if($_GET['m']=='bankomats'){
		//--- карта
		if (file_exists('pool/src/coord_data/bankomats2.inc')){
			include('pool/src/coord_data/bankomats2.inc');
