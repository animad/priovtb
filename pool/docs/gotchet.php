<?php
	...
	$list['gotchet']['years']=array(2011,2010,2009,2008,2007,2006,2005,2004,2003,2002,2001);
	
	$list['gotchet'][2011][]=array('pool/files/gotchet/msfo2011_konsol.zip','отчет по МСФО (консолидированный)','f');
	$list['gotchet'][2011][]=array('pool/files/gotchet/msfo2011_nekonsol.zip','отчет по МСФО (неконсолидированный)','f');
	$list['gotchet'][2011][]=array('pool/files/gotchet/godovotchet_2011.pdf','годовой отчет ОАО &laquo;ПРИО-ВНЕШТОРГБАНК&raquo;','f');
	$list['gotchet'][2011][]=array('finans11.php','формы финансовой отчетности','p');
     
	$list['gotchet'][2010][]=array('pool/files/gotchet/msfo2010.pdf','отчет по МСФО','f');
	$list['gotchet'][2010][]=array('pool/files/gotchet/g2010.pdf','годовой отчет ОАО &laquo;ПРИО-ВНЕШТОРГБАНК&raquo;','f');
	$list['gotchet'][2010][]=array('finans10.php','формы финансовой отчетности','p');
 
	$list['gotchet'][2009][]=array('pool/files/gotchet/msfo2009.zip','отчет по МСФО','f');
	$list['gotchet'][2009][]=array('pool/files/gotchet/g2009.zip','годовой отчет ОАО &laquo;ПРИО-ВНЕШТОРГБАНК&raquo;','f');
	...
	$list['gotchet'][2008][]=array('pool/files/gotchet/g2008.zip','годовой отчет ОАО &laquo;ПРИО-ВНЕШТОРГБАНК&raquo;','f');
	...
	$list['gotchet'][2007][]=array('pool/files/gotchet/g2007.zip','годовой отчет ОАО &laquo;ПРИО-ВНЕШТОРГБАНК&raquo;','f');
	$list['gotchet'][2007][]=array('finans07.php','формы финансовой отчетности','p');

	$list['gotchet'][2006][]=array('pool/files/gotchet/g2006.zip','годовой отчет ОАО &laquo;ПРИО-ВНЕШТОРГБАНК&raquo;','f');
	$list['gotchet'][2006][]=array('finans06.php','формы финансовой отчетности','p');

	$list['gotchet'][2005][]=array('pool/files/gotchet/g2005.zip','годовой отчет ОАО &laquo;ПРИО-ВНЕШТОРГБАНК&raquo;','f');
	$list['gotchet'][2005][]=array('finans05.php','формы финансовой отчетности','p');

	$list['gotchet'][2004][]=array('pool/files/gotchet/g2004.zip','годовой отчет ОАО &laquo;ПРИО-ВНЕШТОРГБАНК&raquo;','f');
