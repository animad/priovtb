<?php
	...
	$_pagevars['col'][4]=array(0,1);
	$_pagevars['align'][4]=array('left','right');
	$_pagevars['valign'][4]=array('top','middle');
...
<!-- BEGIN -->
<h1>Годовая форма финансовой отчетности год 2011</h1>
...
<table border="0" cellspacing="1" cellpadding="5" class="table5">
	...
	<?php print draw_otch1('pool/src/finans2011/form_807_2011.csv',2); ?>
</table>

<br />
<h1>БАЛАНС НА 1 ЯНВАРЯ 2012 ГОДА</h1>
<table border="0" cellspacing="1" cellpadding="5" class="table5">

	<?php print draw_otch1('pool/src/finans2011/form_806_2011.csv',2); ?>
</table>

<br />
<h1>ОТЧЕТ ОБ УРОВНЕ ДОСТАТОЧНОСТИ КАПИТАЛА, ВЕЛИЧИНЕ РЕЗЕРВОВ НА ПОКРЫТИЕ СОМНИТЕЛЬНЫХ ССУД И ИНЫХ АКТИВОВ</h1>
<p align="center">по состоянию на 1 января 2012 года</p>
<table border="0" cellspacing="1" cellpadding="5" class="table5">
	<?php print draw_otch1('pool/src/finans2011/form_808_2011.csv',3); ?>
</table>
<table border="0" cellspacing="1" cellpadding="5" class="table5">
	<?php print draw_otch1('pool/src/finans2011/spravochno.csv',1); ?>
</table>

<h1>Отчет О ДВИЖЕНИИ ДЕНЕЖНЫХ СРЕДСТВ ЗА 2011 ГОД</h1>
<table border="0" cellspacing="1" cellpadding="5" class="table5">
	<?php print draw_otch1('pool/src/finans2011/form_814_2011.csv',3); ?>
</table>



<h1>СВЕДЕНИЯ ОБ ОБЯЗАТЕЛЬНЫХ НОРМАТИВАХ НА 1 ЯНВАРЯ 2012 ГОДА</h1>
<table border="0" cellspacing="1" cellpadding="5" class="table5">
	<?php print draw_otch1('pool/src/finans2011/form_813_2011.csv',3); ?>
</table>

<h1>Аудиторское заключение</h1>
<p>По мнению  ЗАО "Аудиторско-Консультационная фирма" "МИАН"  бухгалтерская отчетность отражает достоверно во всех существенных отношениях финансовое положение Банка "ПРИО-ВНЕШТОРГБАНК"  (ОТКРЫТОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО) по состоянию  на 31 декабря 2011 года и результаты его финансово-хозяйственной деятельности и движение денежных средств за  2011 год  в соответствии  с установленными правилами составления бухгалтерской отчетности Российской Федерации».</p>
