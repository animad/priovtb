...
/*
--- список страниц
	$pageList->get($res,20,$_SERVER['REQUEST_URI'],(isset($_GET['page'])?$_GET['page']:0),10,'desc');
...
--- доступ к результату
	==> $pageList->pglist; //--- список сраниц
	==> $pageList->list;   //--- список записей
...
*/
	...
	class pageList{		var $pglist=null;
		...
		function get($res=null,$per_page=20,$url=null,$page1=0,$pnppage=10,$numOrder='desc',$ancor=''){			global $globals;
			...
			$css_btn1=$globals['pglist']['css_btn1'];
			$css_btn1Active=$globals['pglist']['css_btn1Active'];
			...
			if($res!=null && $url!=null){
				...
				if(isset($pages) && $pages>1){
					...
					$pglist='<div align="center" style="margin: 5px 0">'.
