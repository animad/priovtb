<?php
	...
	$_pagevars['row_decor']['odd']=array(' bgcolor=#eeeeee',' bgcolor=#eeeeee',' bgcolor=#cccccc');
	$_pagevars['row_decor']['even']=array(' bgcolor=#ffffff',' bgcolor=#ffffff',' bgcolor=#eeeeee');
