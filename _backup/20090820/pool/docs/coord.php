...
//--- подпись для ТЕРМИНАЛОВ
	if($_GET['m']=='terminals'){
		...
		print '<li>оплатить услуги связи (как сотового оператора, так и за стационарный номер). Платежи за услуги Центртелекома и Ростелекома принимаются без комиссии. Комиссия платежа за услуги МТС, Билайн, Мегафон, Скайлинк, НТВ+ и Интерлинк составляет 5 рублей вне зависимости от суммы оплаты.</li>';
		print '</ul>';
	}
