...
//						      '<div style="text-align: center; margin: 5px 0;">'.output($_SESSION['user']['fio']).'<br />'.output($_SESSION['user']['org']).'</div>'.
						      '<div style="text-align: center; margin: 5px 0;">'.output($_SESSION['user']['org']).'</div>'.
...
*/							  '<tr'.$this->colrow($j1++).'>'.
		...
		public function create(){
			...
			if(isset($_POST['login']) && isset($_POST['inn']) && isset($_POST['org']) && isset($_POST['email'])){ //&& isset($_POST['fio']) 
				if(trim($_POST['login'])!='' && trim($_POST['inn'])!='' && trim($_POST['org'])!='' && trim($_POST['email'])!=''){ // && trim($_POST['fio'])!=''
