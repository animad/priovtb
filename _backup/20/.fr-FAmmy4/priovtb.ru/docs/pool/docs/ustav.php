<?php
	...
	$list['ustav'][]=array('ustav4.pdf','Изменения №4 к Уставу 2012 г (действующая редакция)');
	...
	$list['polog'][]=array('pologeni_o_sovet_directorov_2011.pdf','Положение о Совете директоров - 2011 г (действующая редакция)');
	$list['polog'][]=array('pologeni_o_predsedatel_pravlenia_2011.pdf','Положение о Правлении и Председателе Правления 2011 г (действующая редакция)');
	...
	$list['other'][]=array('upol2012.zip','Учетная политика на 2012 г');
	$list['other'][]=array('candidate2011.zip','Требования к пакету документов по выдвижению кандидатов в члены Совета директоров Прио-Внешторгбанка (ОАО) в соответствии с решением Совета директоров протокол от 06.10.2008, 01.02.2011 г.');
