...
mmenu_pool={
	...
	about:{ nm:"about", on:"1", show:"1", active:"1", def:"0", raiting:"1", raiting:"0", title:"О банке", href:"history.php",
		smenu:{
			...
			let15:{ nm:"let15", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Пятнадцатиление Прио-Внешторгбанка", href:"15let.php",
				smenu:{
					s1:{ nm:"s1", on:"1", show:"0", active:"0", def:"1", raiting:"0", order:"20041117", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"17 ноября. В ПВТБ прошел день открытых дверей.", href:"15let.php&s=1", smenu:"" },
					s2:{ nm:"s2", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041130", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"30 ноября - 6 декабря. Акция «Сувениры вкладчикам»", href:"15let.php&s=2", smenu:"" },
					s3:{ nm:"s3", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041203", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"3 декабря. Концерт для детей-инвалидов", href:"15let.php&s=3", smenu:"" },
					s4:{ nm:"s4", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041203", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"3 декабря. Статьи в СМИ", href:"15let.php&s=4", smenu:"" },
					s5:{ nm:"s5", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041203", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"3 декабря. Фотогалерея", href:"15let.php&s=5", smenu:"" },
					s6:{ nm:"s6", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041204", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"4 декабря. Турнир по спортивным бальным танцам Прио-Внешторгбанка", href:"15let.php&s=6", smenu:"" },
					s7:{ nm:"s7", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041204", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"4 декабря. Статьи в СМИ", href:"15let.php&s=7", smenu:"" },
					s8:{ nm:"s8", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041204", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"4 декабря. Фотогалерея", href:"15let.php&s=8", smenu:"" },
					s9:{ nm:"s9", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041206", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"6 декабря. Презентация проекта Прио-Внешторгбанка по строительству детского игрового городка в парке на ул. Ленина", href:"15let.php&s=9", smenu:"" },
					s10:{ nm:"s10", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041206", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"6 декабря. Статьи в СМИ", href:"15let.php&s=10", smenu:"" },
					s11:{ nm:"s11", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041206", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"6 декабря. Положение", href:"15let.php&s=11", smenu:"" },
					s12:{ nm:"s12", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041206", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"6 декабря. Фотогалерея", href:"15let.php&s=12", smenu:"" },
					s13:{ nm:"s13", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041209", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"9 декабря. В Прио-Внешторгбанке состоялся «круглый стол» на тему «Информационная открытость кредитно-финансовых учреждений. Актуальные вопросы взаимодействия Банка и СМИ.»", href:"15let.php&s=13", smenu:"" },
					s14:{ nm:"s14", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041209", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"9 декабря. Положение", href:"15let.php&s=14", smenu:"" },
					s15:{ nm:"s15", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20041209", title_p:"Пятнадцатиление Прио-Внешторгбанка", title:"9 декабря. Фотогалерея", href:"15let.php&s=15", smenu:"" }
				}
			},
			let18:{ nm:"let18", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Восемнадцатиление Прио-Внешторгбанка", href:"18let.php",
				smenu:{
					s1:{ nm:"s1", on:"1", show:"0", active:"0", def:"1", raiting:"0", order:"20071019", title_p:"Восемнадцатиление Прио-Внешторгбанка", title:"19 октября. Положение о конкурсе, проводимом Прио-Внешторгбанком (ОАО) в газете «ТЕЛЕСЕМЬ» в связи с 18-ти летием со дня создания.", href:"18let.php&s=1", smenu:"" },
					s2:{ nm:"s2", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20071025", title_p:"Восемнадцатиление Прио-Внешторгбанка", title:"25 октября. 1-й этап конкурса (ТЕЛЕСЕМЬ).", href:"18let.php&s=2", smenu:"" },
					s3:{ nm:"s3", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20071025", title_p:"Восемнадцатиление Прио-Внешторгбанка", title:"25 октября. Победитель 1-го тура викторины.", href:"18let.php&s=3", smenu:"" },
					s4:{ nm:"s4", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20071101", title_p:"Восемнадцатиление Прио-Внешторгбанка", title:"1 ноября. 2-й этап конкурса (ТЕЛЕСЕМЬ).", href:"18let.php&s=4", smenu:"" },
					s5:{ nm:"s5", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20071201", title_p:"Восемнадцатиление Прио-Внешторгбанка", title:"1 ноября. Победитель 2-го тура викторины.", href:"18let.php&s=5", smenu:"" },
					s6:{ nm:"s6", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20071208", title_p:"Восемнадцатиление Прио-Внешторгбанка", title:"8 ноября. 3-й этап конкурса (ТЕЛЕСЕМЬ).", href:"18let.php&s=6", smenu:"" },
					s7:{ nm:"s7", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20071208", title_p:"Восемнадцатиление Прио-Внешторгбанка", title:"8 ноября. Победитель 3-го тура викторины.", href:"18let.php&s=7", smenu:"" },
					s8:{ nm:"s8", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20071215", title_p:"Восемнадцатиление Прио-Внешторгбанка", title:"15 ноября. Победитель 4-го тура викторины.", href:"18let.php&s=8", smenu:"" },
					s9:{ nm:"s9", on:"1", show:"0", active:"0", def:"0", raiting:"0", order:"20071223", title_p:"Восемнадцатиление Прио-Внешторгбанка", title:"23 ноября. Победитель 5-го тура викторины.", href:"18let.php&s=9", smenu:"" }
				}
			},
			...
			finres:{ nm:"finres", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Отчетность и финансовые результаты", href:"",
				smenu:{
					finans08:{ nm:"finans08", on:"1", show:"1", active:"1", def:"0", raiting:"1", title_p:"Отчетность и финансовые результаты", title:"год 2008", href:"finans08.php", smenu:"" },
					...
					finans05:{ nm:"finans05", on:"1", show:"1", active:"1", def:"0", raiting:"0", title_p:"Отчетность и финансовые результаты", title:"год 2005", href:"finans05.php", smenu:"" },
					finans04:{ nm:"finans04", on:"1", show:"1", active:"1", def:"0", raiting:"0", title_p:"Отчетность и финансовые результаты", title:"год 2004", href:"finans04.php", smenu:"" },
					finans03:{ nm:"finans03", on:"1", show:"1", active:"1", def:"0", raiting:"0", title_p:"Отчетность и финансовые результаты", title:"год 2003", href:"finans03.php", smenu:"" },
					finans02:{ nm:"finans02", on:"1", show:"1", active:"1", def:"0", raiting:"0", title_p:"Отчетность и финансовые результаты", title:"год 2002", href:"finans02.php", smenu:"" },
					finans01:{ nm:"finans01", on:"1", show:"1", active:"1", def:"0", raiting:"0", title_p:"Отчетность и финансовые результаты", title:"год 2001", href:"finans01.php", smenu:"" }
				}
			},
	...
	fiz:{ nm:"fiz", on:"1", show:"1", active:"1", def:"0", raiting:"1", raiting:"0", title:"Услуги для Вас", href:"vklad.php", exclude:"main.php",
		smenu:{
			...
			cred_fiz:{ nm:"cred_fiz", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Кредитование физических лиц", href:"cred_fiz.php", smenu:"" }
