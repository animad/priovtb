					              ...
					              '<tr class="footer"><td class="l"></td><td class="data">'.
					                  '<form name="" action="" style="margin: 0; padding: 0;">'.
					                      '<table class="form1" cellpadding="2"><tr>'.
					                          '<td width="160" class="text1">Подписаться на новости</td>'.
					                          '<td width="5">&nbsp;</td>'.
					                          '<td width="150"><input name="email" id="email" type="text" value="" class="input"></td>'.
					                          '<td width="5">&nbsp;</td>'.
					                          '<td width="40"><a href="#" onClick="get_news(document.getElementById(\'email\').value); return false;">Ок</a></td>'.
					                          '<td></td>'.
					                          '<td width="120"><a href="?dr=news_all.php">Архив новостей</a></td>'.
									      '</tr></table>'.
								      '</form>'.
							      '</td><td class="r"></td></tr>'.
