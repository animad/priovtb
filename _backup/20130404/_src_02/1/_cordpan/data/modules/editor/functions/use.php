<?php
	...
	$this->tools[$ti['tool']]['js']['load_pics']='<script type="text/javascript" src="/pool/vars/image_list.js"></script>';
	...
	tinyMCE.init({
		...
		external_link_list_url : "cordpan/'.$this->tools[$ti['tool']]['path'].'/lists/link_list.js",
		external_image_list_url : "cordpan/'.$this->tools[$ti['tool']]['path'].'/lists/image_list.js",
		media_external_list_url : "cordpan/'.$this->tools[$ti['tool']]['path'].'/lists/media_list.js"
