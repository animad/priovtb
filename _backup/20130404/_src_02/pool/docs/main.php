...
<!-- 740x300 -->
				<a href="?dr=rekvizit.php" class="quick_contact" title="единая справочная: +7 (4912) 24-49-24; электронная почта: post@priovtb.com">&nbsp;</a>
				<script type="text/javascript" src="files/scripts/running_ban.js"></script>
				<a href="/?dr=vklad.php" class="btn1" title="Услуги для Вас">&nbsp;</a>
				<a href="/?dr=rko.php" class="btn2" title="Услуги для Вашего бизнеса">&nbsp;</a>
			</div>
			...
			<div style="position: relative; width: 710px; height: 220px; margin-bottom: 20px;">
				...
				<a href="?dr=info_20101220.php" id="banner_04"><span>Всем клиентам &mdash;<br />юридическим лицам<br />и предпринимателям нужно<br />перезаключить договора банковского счета.<br /><br /><div class="hrf5">Подробнее</div></span></a>
