...
//--- ИНТЕРФЕЙС ---
		...
		case 'create_ui':
			...
			if(isset($_modvars['use_external_editorHTML']) && $_modvars['use_external_editorHTML'] && isset($mod->tools['editorHTML']['uId'])){
				...
				$editor[$k]['r']['sz_height']='100px';
				$editor[$k]['r']['sz_width']='100%';
				$editor[$k]['r']['work_element']='publicate';
				$editor[$k]['r']['css_body']='';
				$editor[$k]['r']['work_text']=$publicate;
				...
				$editor[$k]['r']['sz_height']='100px';
				$editor[$k]['r']['sz_width']='100%';
				$editor[$k]['r']['work_element']='story';
				$editor[$k]['r']['css_body']='';
				$editor[$k]['r']['work_text']=$story;
				...
				$val1_editor_init=$mod->tools['editorHTML']['js']['load'].$editor[1]['jsinit'];
				$val1_editor=$editor[1]['html'];

				$val2_editor_init=$mod->tools['editorHTML']['js']['load'].$editor[2]['jsinit'];
				$val2_editor=$editor[2]['html'];
			}else{
				$val1_editor_init='';
				$val1_editor='<textarea style="width: 500px" type="text" name="requirement">'.trim($requirement).'</textarea>';

				$val2_editor_init='';
				$val2_editor='<textarea style="width: 500px" type="text" name="requirement">'.trim($requirement).'</textarea>';
			}


				$data1[]=$val1_editor_init;
				$data1[]=$val2_editor_init;
