...
mmenu_pool={
		...
		smenu:{
			...
			cred_fiz:{ nm:"cred_fiz", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Кредитование физических лиц", href:"",
				smenu:{
					...
					cred_ipoteka:{ nm:"cred_ipoteka", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Ипотечный кредит", href:"cred_ipoteka.php", smenu:"" },
										cred_potreb:{ nm:"cred_potreb", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Потребительское кредитование", href:"" ,
							smenu1:{
							cred_fiz:{ nm:"cred_fiz", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"a).потребительский кредит для физических лиц", href:"cred_fiz.php", smenu:"", smenu1:"" },
							cred_potreb_nedviz:{ nm:"cred_potreb_nedviz", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"б).потребительский кредит под залог недвижимости", href:"cred_potreb_nedviz.php", smenu:"" , smenu1:""},
							}
					cred_gotov:{ nm:"cred_gotov", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Кредитование на вторичном рынке жилья", title2:"Кредитование физических лиц", href:"cred_gotov.php", smenu:"" },
					cred_novostrojk:{ nm:"cred_novostrojk", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Условия кредитования покупки квартир в новостройках города", title2:"Кредитование физических лиц", href:"cred_novostrojk.php", smenu:"" },
	...
	biz:{ nm:"biz", on:"1", show:"1", active:"1", def:"0", raiting:"1", raiting:"0", title:"Услуги для Вашего бизнеса", href:"rko.php", exclude:"main.php",
		smenu:{
			...
			tarif:{ nm:"tarif", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Базовые тарифы", title2:"<br />на расчетно-кассовое обслуживание юридических лиц и индивидуальных предпринимателей", href:"tarif.php", smenu:"" }
		}
	},
