<?php
	...
	$this->tools[$ti['tool']]['path']=$_dir['modplace_http'].'editor';
	$this->tools[$ti['tool']]['js']['load']='<script type="text/javascript" src="'.$this->tools[$ti['tool']]['path'].'/tiny_mce/tiny_mce_src.js"></script>'.
						'<script type="text/javascript" src="'.$this->tools[$ti['tool']]['path'].'/lists/image_list.js"></script>';
...
//		editor_selector : "%work_element%",
		...
		// Theme options
		theme_advanced_buttons1 : "cut,copy,paste,|,bold,italic,underline,|,justifyleft,justifycenter,justifyright,|,sub,sup,|,bullist,numlist,|,image,link,unlink,hr,|,cleanup,code",
...
//		document_base_url : "http://'.$_SERVER['SERVER_NAME'].$_dir['site_postfix'].'/",
		...
		template_external_list_url : "'.$this->tools[$ti['tool']]['path'].'/lists/template_list.js",
		external_link_list_url : "../pool/vars/link_list.js",
		external_image_list_url : "../pool/vars/image_list.js",
		media_external_list_url : "'.$this->tools[$ti['tool']]['path'].'/lists/media_list.js"
...
//		editor_selector : "%work_element%",
	...
	$this->tools[$ti['tool']]['html']['textarea']='<textarea id="%work_element%" class="%work_element%" name="%work_element%" style="width: %sz_width%; height: %sz_height%; background-color: yellow">%work_text%</textarea>';
