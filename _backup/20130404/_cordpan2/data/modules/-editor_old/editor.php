<?php
	...
	$data_ilist=list_img('files/pool/images');
...
<script type="text/javascript">
	tinyMCE.init({
		...
		template_external_list_url : "cordpan/<?=$p1;?>/lists/template_list.js?" + new Date().getTime(),
		external_link_list_url : "cordpan/<?=$p1;?>/lists/link_list.js?" + new Date().getTime(),
		external_image_list_url : "cordpan/<?=$p1;?>/lists/image_list.js?" + new Date().getTime(),
		media_external_list_url : "cordpan/<?=$p1;?>/lists/media_list.js?" + new Date().getTime(),
