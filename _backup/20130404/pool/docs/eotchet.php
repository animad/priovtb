...
//				$data[]='<li>test</li>';
	...
	$list['eotchet'][2011][]=array('pool/files/eotchet/form806_27042012.zip','за 1 квартал - бухгалтерский баланс','f');
	$list['eotchet'][2011][]=array('pool/files/eotchet/form808_27042012.zip','за 1 квартал - отчет об уровне достаточности капитала, величине резервов на покрытие сомнительных ссуд и иных активов','f');
	$list['eotchet'][2011][]=array('pool/files/eotchet/form807_27042012.zip','за 1 квартал - отчет о прибылях и убытках','f');
