<?php
	...
	$list['ustav'][]=array('ustav2.zip','Изменения №2 к Уставу 2008 г (действующая редакция)');
	$list['ustav'][]=array('ustav3.zip','Изменения №3 к Уставу 2010 г (действующая редакция)');
	
	$list['polog'][]=array('polog_o_voz_sovet.zip','Положение о размерах вознаграждения членов Совета директоров за период исполнения ими своих обязанностей и компенсации расходов, связанных с исполнением ими функций членов Совета директоров');
	$list['polog'][]=array('izm_polog_sovet.zip','Изменения №1, вносимые в Положение о Совете директоров');
	$list['polog'][]=array('izm_polog_plavlenie.zip','Изменения №1, вносимые в Положение о Правлении и Председателе Правления');	
	$list['polog'][]=array('pologenie2008.zip','Положение о Совете директоров - 2008 г (действующая редакция)');
	$list['polog'][]=array('sovet.zip','Положение о Cовете директоров 2004 г (старая редакция)');	
	...
	$list['other'][]=array('upol2010.zip','Учетная политика на 2010 г');
	...
	$list['other'][]=array('candidate2008.zip','Требования к пакету документов по выдвижению кандидатов в члены Совета директоров Прио-Внешторгбанка (ОАО) в соответствии с решением Совета директоров от 26.12.2007 года протокол № 10 от 06.10.2008 ');
