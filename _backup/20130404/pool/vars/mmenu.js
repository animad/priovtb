...
mmenu_pool={
			...
			cred_fiz:{ nm:"cred_fiz", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Кредитование физических лиц", href:"",
				...
				smenu:{
					...
					cred_realestate:{ nm:"cred_realestate", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Потребительский кредит под залог недвижимости", href:"cred_realestate.php", smenu:"" },
         				cred_delta:{ nm:"cred_delta.php", on:"1", show:"1", active:"1", def:"0", raiting:"1", title:"Ипотечные кредиты по программе ДельтаКредит", href:"cred_delta.php", smenu:"" },
	...
	realization_of_bail:{ nm:"realization_of_bail", on:"1", show:"0", active:"1", def:"0", raiting:"1", title:"Реализация залогового имущества клиентами Прио-Внешторгбанка", href:"realization_of_bail.php", smenu:"" },
